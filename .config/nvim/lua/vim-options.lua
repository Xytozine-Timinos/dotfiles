...
km.set("n", "<C-w>.", "<C-W>>", { noremap = true, silent = true })
km.set("n", "<C-w>,", "<C-W><", { noremap = true, silent = true })
km.set("n", "<C-w>-", "<C-W>-", { noremap = true, silent = true })
km.set("n", "<C-w>=", "<C-W>+", { noremap = true, silent = true })
km.set("n", "<C-w><BS>", "<C-W>=", { noremap = true, silent = true })

km.set("n", "f", "b", { noremap = true, silent = true })
km.set("n", "j", "w", { noremap = true, silent = true })
km.set("v", "f", "b", { noremap = true, silent = true })
km.set("v", "j", "w", { noremap = true, silent = true })
km.set("n", "i", "a", { noremap = true, silent = true })
km.set("n", "k", "a", { noremap = true, silent = true })
km.set("n", "l", "i", { noremap = true, silent = true })
